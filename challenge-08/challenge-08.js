...
seu nome.
*/
var nome = "João Vitor Nunes Carvalho";
...
console.log("A função " + varShowName.name +" retorna " + varShowName(nome) + ".")
...
function calculator(operador){
  return function calculo(number1,number2){
    var resultado;
    switch(operador){
      case "-": 
